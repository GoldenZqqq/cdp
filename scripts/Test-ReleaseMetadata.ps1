...
$checks += New-CdpMetadataCheck -Name 'scoop.url' -Actual ([string]$scoop.url) -Expected "https://github.com/GoldenZqqq/cdp/archive/refs/tags/v$version.zip"
$checks += New-CdpMetadataCheck -Name 'scoop.extract_dir' -Actual ([string]$scoop.extract_dir) -Expected "cdp-$version"
$checks += New-CdpMetadataCheck -Name 'scoop.autoupdate.url' -Actual ([string]$scoop.autoupdate.url) -Expected 'https://github.com/GoldenZqqq/cdp/archive/refs/tags/v$version.zip'
